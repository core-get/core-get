...
class TestCommonOptionsParser(TestCase):
    ...
    def test_parses_offline_correctly(self):
        common_options = test_parse(CommonOptionsParser, '--offline')
